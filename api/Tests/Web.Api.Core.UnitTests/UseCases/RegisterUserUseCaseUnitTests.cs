...
namespace Web.Api.Core.UnitTests.UseCases
{
    public class RegisterUserUseCaseUnitTests
    {
        ...
        [Fact]
        public async void Handle_GivenDuplicateEmailRegistrationDetails_ShouldFail()
        {
            // arrange
            ...
            mockUserRepository
              .Setup(repo => repo.Create(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()))
              .ReturnsAsync(value: new CreateUserResponse("", false, new[] { new Error("", "") }));
        ...
        [Fact]
        public async void Handle_GivenDuplicateUsernameRegistrationDetails_ShouldFail()
        {
            // arrange
