...
namespace Web.Api.Infrastructure
{
    public class InfrastructureModule : Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<GuestUserRepository>().As<IGuestUserRepository>().InstancePerLifetimeScope();
            builder.RegisterType<GuestEntryRepository>().As<IGuestEntryRepository>().InstancePerLifetimeScope();
