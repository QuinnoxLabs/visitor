...
namespace Web.Api
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            // Register the ConfigurationBuilder instance of ApiCustomErrors
            var apiCustomErrors = Configuration.GetSection(nameof(ApiCustomValues));
            services.Configure<ApiCustomValues>(apiCustomErrors);
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "ODC.GuestEntryExit", Version = "v1" });
                // Swagger 2.+ support
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "ODC.GuestEntryExit V1");
            });
